/**
 * A PrefixSum model, maintains the range sum of an 2D array.
...
class PrefixSum_2D {
    ...
    /**
     * An array that maintains the PrefixSum of the original 2D array.
     */
    int[][] pre;
    ...
    /**
     * Get the sum of range[l1, r1][l2, r2] of the 2D array.
